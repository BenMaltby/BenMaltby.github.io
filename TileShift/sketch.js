class tile{
  ...
  let Pallete = [
	...
	["#c8102e","#ffffff","#012169"],  // uk
	["#8ecae6","#219ebc","#023047","#ffb703","#fb8500"],  // blue and gold
	["#da2c38","#226f54","#87c38f","#f4f0bb","#43291f"],  // christmas
	["#44355b","#31263e","#221e22","#eca72c","#ee5622"],  // halloween
	["#780116","#f7b538","#db7c26","#d8572a","#c32f27"],  // fire
	["#d6d6d6","#ffee32","#ffd100","#202020","#333533"],  // Black and Yellow
	["#0b090a","#161a1d","#660708","#a4161a","#ba181b","#e5383b","#b1a7a6","#d3d3d3","#f5f3f4","#ffffff"],  // blood and spider
	["#00193a","#002b53","#023f73","#034780","#7a0213","#a10220","#bf0a26","#cd0c2b","#131313","#262626"],  // blood moon
	["#39d05c","#35e95f","#35d475","#35ac7a","#347f83","#2e518a","#40288f","#5702a1","#6500a3","#8127b9"],  // hulk
	["#e5383b","#ff7900","#ff8500","#ff9100","#ff9e00","#240046","#3c096c","#5a189a","#7b2cbf","#9d4edd"]  // halloween 2
  ]
